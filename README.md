...
_Prerequisites:_ Node v6.9.5, Yarn v0.20.3, Mongo DB v3.4+ (needs at least 4GB of free disk space for the initial database), Nginx (optional, skip if you don't need the proxy server).
