...
// NOTE The flow type inferencer is currently not powerful enough to type Ramda. 
...
//   }
// 
//   declare interface Semigroup<T> {
//       concat(b: Semigroup<T>): Semigroup<T>;
//   }
// 
//   declare interface Monoid<T> extends Semigroup<T> {
...
//   }
// 
//   declare interface Apply<T> extends Functor<T> {
//       apply<U>(fn: Apply<(t: T) => U>): Apply<U>;
//   }
// 
//   declare interface Applicative<T> extends Apply<T> {
//       /* static */ of<U>(a: U): Applicative<U>;
//   }
// 
//   declare interface Alt<T> extends Functor<T> {
//       alt(b: T): Alt<T>;
//   }
// 
//   declare interface Plus<T> extends Alt<T> {
//       /* static */ zero<T>(): Plus<T>;
//   }
// 
//   declare interface Alternative<T> extends Plus<T>, Applicative<T> {
//   }
// 
//   declare interface Foldable<T> {
//       reduce<U>(fn: (u: U, t: T) => U, u: U): U;
//   }
// 
//   declare interface Traversable<T> extends Functor<T>, Foldable<T> {
//       traverse<U, V>(fn: (t: T) => Applicative<U>, of: (v: V) => Applicative<V>): Applicative<Traversable<U>>;
//   }
// 
//   declare interface Chain<T> extends Apply<T> {
//       chain<U>(fn: (t: T) => Chain<U>): Chain<U>;
//   }
// 
//   declare interface ChainRec<T> extends Chain<T> {
//       /* static */ chainRec<A,B,C>(f: (next: (a: A) => C, done: (b: B) => C, value: A) => ChainRec<C>, i: A): ChainRec<B>;
//   }
// 
//   declare interface Monad<T> extends Applicative<T>, Chain<T> {
//   }
// 
//   declare interface Extend<T> {
//       extend<U>(f: (v: Extend<T>) => U): Extend<U>;
//   }
// 
//   declare interface Comonad<T> extends Functor<T>, Extend<T> {
//       extract<U>(): U; // 'same U as in extend's f -- how to bind?
//   }
// 
//   declare interface Bifunctor<T,U> extends Functor<T> /*, Functor<U>*/ {
//       bimap<B,D>(f: (v: T) => B, g: (v: U) => D): Bifunctor<B,D>;
//   }
// 
//   declare interface Profunctor<T,U> extends Functor<T> /*, Functor<U>*/ {
...
//   declare type Ord = string | number | boolean | Date;
// 
//   declare interface Dictionary<T> {
//       [index: string]: T;
//   }
// 
//   declare type Obj<T> = Dictionary<T>;
//   declare type List<T> = Array<T>;
//   declare type StringLike = string | StringRepresentable<string>;
//   declare type Prop = Index | StringRepresentable<Index>;
//   declare type Path = List<Prop>;
//   declare type Struct<T> = Obj<T> | List<T>;
//   declare type AccOpts<T,U> = List<any> | Obj<any> | Transformer<T, U, U>;
//   declare type Pred<T> = (v: T) => boolean;
//   declare type ObjPred<T> = (value: T, key: string) => boolean;
// 
//   // Ramda interfaces
// 
...
//   }
// 
//   declare interface Variadic<T> {
//       (...args: any[]): T;
//   }
// 
//   declare interface Transformer<T, Acc, Res> {
...
//   }
// 
//   declare interface StringRepresentable<T> {
//       toString(): T;
//   }
// 
//   declare interface NestedObj<T> {
//       [index: string]: T|NestedObj<T>;
//   }
// 
//   // interface RecursiveArray<T> extends Array<T|RecursiveArray<T>> {}
//   // interface ListOfRecursiveArraysOrValues<T> extends List<T|RecursiveArray<T>> {}
//   declare interface NestedArray <T> {
...
//   // interface KeyLens<T: Struct<any>, K: $Keys<T>> {
//   //     // <T: Struct<any>>
//   //     (obj: T): T[K]; // get
//   //     set(v: T[K], obj: T): T;
//   //     // map(fn: (v: T[K]) => T[K], obj: T): T
//   // }
//   declare interface Lens<T,U> {
//       (obj: T): U; // get
//       set(v: U, obj: T): T;
//       // map(fn: (v: U) => U, obj: T): T
//   }
//   declare interface ManualLens<U> {
//       <T: Struct<any>>(obj: T): U; // get
//       set<T: Struct<any>>(v: U, obj: T): T;
//       // <T: Struct<any>>map(fn: (v: U) => U, obj: T): T
//   }
//   declare interface UnknownLens {
//       <T,U>(obj: T): U; // get
//       set<T,U>(v: U, obj: T): T;
...
//   //     (v1: T1): R;
//   // }
//   declare type CurriedFunction1<T1, R> = (v1: T1) => R;
// 
...
//       (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6): R;
//   }
//   declare interface CurriedFunction7<T1, T2, T3, T4, T5, T6, T7, R> {
...
//       (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7): R;
//   }
//   declare interface CurriedFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
...
//       (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7, v8: T8): R;
//   }
//   declare interface CurriedFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
...
// 
// 
//   declare interface CurriedFn1<T1, R> {
//     (v1: T1): R;
//   }
//   declare interface CurriedFn2<T1, T2, R> {
//     (v1: T1, v2: T2): R;
//     (v1: T1): (v2: T2) => R;
//   }
//   declare interface CurriedFn3<T1, T2, T3, R> {
//     (v1: T1, v2: T2, v3: T3): R;
//     (v1: T1, v2: T2): (v3: T3) => R;
//     (v1: T1): {
//       (v2: T2, v3: T3): R;
...
//     };
//   }
//   declare interface CurriedFn4<T1, T2, T3, T4, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4): R;
//     (v1: T1, v2: T2, v3: T3): (v4: T4) => R;
//     (v1: T1, v2: T2): {
//       (v3: T3, v4: T4): R;
...
//     };
//   }
//   declare interface CurriedFn5<T1, T2, T3, T4, T5, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5): R;
//     (v1: T1, v2: T2, v3: T3, v4: T4): (v5: T5) => R;
//     (v1: T1, v2: T2, v3: T3): {
//       (v4: T4, v5: T5): R;
...
//     };
//   }
//   declare interface CurriedFn6<T1, T2, T3, T4, T5, T6, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6): R;
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5): (v6: T6) => R;
...
//     };
//   }
//   declare interface CurriedFn7<T1, T2, T3, T4, T5, T6, T7, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7): R;
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6): (v7: T7) => R;
...
//     };
//   }
//   declare interface CurriedFn8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7, v8: T8): R;
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7): (v8: T8) => R;
...
//     };
//   }
//   declare interface CurriedFn9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7, v8: T8, v9: T9): R;
//     (v1: T1, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, v7: T7, v8: T8): (v9: T9) => R;
...
//     all<T>(pred: Pred<T>, ...rest: Array<void>): (list: List<T>) => boolean;
...
//     and<T: {and?: Function;}>(fn1: T, val2: boolean | any): boolean;
//     and<T: {and?: Function;}>(fn1: T): (val2: boolean | any) => boolean;
...
//      */
//     ascend<T, V: Ord>(comparator: (val: T) => V, a: T, b: T): number;
//     ascend<T, V: Ord>(comparator: (val: T) => V, a: T): (b: T) => number;
//     ascend<T, V: Ord>(comparator: (val: T) => V): CurriedFunction2<T, T, number>;
//     // ascend<T, V: Ord>: CurriedFunction3<(val: T) => V, T, T, number>;
// 
//     /**
...
//     // assoc<T, U: Struct<any>, K: $Keys<U>>(prop: K, val: T, obj: U): {[P in K]: T} & U;
//     // assoc<T, U: Struct<any>, K: $Keys<U>>(prop: K, val: T): (obj: U) => {[P in K]: T} & U; // generics too early?
//     // assoc<T, U: Struct<any>, K: $Keys<U>>(prop: K): CurriedFunction2<T,U, {[P in K]: T} & U>; // generics too early?
//     // assoc<T, U: Struct<any>, K: $Keys<U>>: CurriedFunction3<K, T, U, {[P in K]: T} & U>;
// 
//     // // extend object with new property
//     // assoc<K: string, T, U: Struct<any>>(prop: K, val: T, obj: U): {[P in K]: T} & U;
//     // assoc<K: string, T>(prop: K, val: T):{
//     //     <U: Struct<any>>(obj: U): {[P in K]: T} & U;
//     // };
//     // assoc<K: string>(prop: K):{
//     //     <T, U: Struct<any>>(val: T, obj: U): {[P in K]: T} & U;
//     //     <T>(val: T):{
//     //         <U: Struct<any>>(obj: U): {[P in K]: T} & U;
//     //     };
//     // };
...
// 
//     // homogeneous object
//     assoc<T, U: Struct<T>>(prop: Prop, val: T, obj: U): U;
//     assoc<T>(prop: Prop, val: T): <U: Struct<T>>(obj: U) => U;
//     assoc<T, U: Struct<T>>(prop: Prop): CurriedFunction2<T, U, U>; // generics too early?
...
//      * of the second.
//      */
//     concat<T: List<any>>(list1: T, list2: T): T;
//     concat<T: List<any>>(list1: T): (list2: T) => T;
//     // concat<T: List<any>>: CurriedFunction2<T, T, T>;
// 
//     /**
...
//     contains<T, R: List<T>>(a: T, list: R): boolean;
//     contains<T, R: List<T>>(a: T): (list: R) => boolean;
//     // contains<T, R: List<T>>: CurriedFunction2<T, R, boolean>;
// 
//     /**
...
//      */
//     descend<T, V: Ord>(comparator: (val: T) => V, a: T, b: T): number;
//     descend<T, V: Ord>(comparator: (val: T) => V, a: T): (b: T) => number;
//     descend<T, V: Ord>(comparator: (val: T) => V): CurriedFunction2<T, T, number>;
//     // descend<T, V: Ord>: CurriedFunction3<(val: T) => V, T, T, number>;
// 
//     /**
...
//     // dissoc<T,U: Struct<any>>(prop: keyof U, obj: U): T;
// 
...
//     // dissoc<U: Struct<any>>(prop: keyof U): <T>(obj: U) => T; // can't do this, don't know U in time
// 
//     // mixed curry:
//     dissoc(prop: Prop): {
//       <T>(obj: T): T; // infer
...
//      */
//     drop<T: List<any>>(n: number, xs: T): T;
//     drop<T: List<any>>(n: number): (xs: T) => T;
//     // drop<T: List<any>>: CurriedFunction2<number, T, T>;
// 
//     /**
//      * Returns a list containing all but the last n elements of the given list.
//      */
//     // = drop
//     dropLast<T: List<any>>(n: number, xs: T): T;
//     dropLast<T: List<any>>(n: number): (xs: T) => T;
//     // dropLast<T: List<any>>: CurriedFunction2<number, T, T>;
// 
//     /**
...
//      */
//     // = dropWhile
//     dropLastWhile<T, R: List<T>>(pred: Pred<T>, list: R): T[];
//     dropLastWhile<T, R: List<T>>(pred: Pred<T>): (list: R) => T[];
//     // dropLastWhile<T, R: List<T>>: CurriedFunction2<Pred<T>, R, T[]>;
// 
//     /**
...
//      */
//     dropWhile<T, R: List<T>>(pred: Pred<T>, list: R): T[];
//     dropWhile<T, R: List<T>>(pred: Pred<T>): (list: R) => T[];
//     // dropWhile<T, R: List<T>>: CurriedFunction2<Pred<T>, R, T[]>;
// 
//     /**
...
// 
//     // object
//     // filter<T,U: Obj<T>>(pred: Pred<T>, obj: U) : Partial<U>;
//     filter<T>(pred: Pred<T>): <U: Obj<T>>(obj: U) => U; // mix
//     // filter<T,U: Obj<T>>: CurriedFunction2<(value: T) => boolean, U, Partial<U>>;
// 
//     // mixed
...
//      */
//     // flatten<T>(x: Array<Array<Array<Array<Array<Array<Array<T>>>>>>>): T[];
//     // flatten<T>(x: Array<Array<Array<Array<Array<Array<T>>>>>>): T[];
//     // flatten<T>(x: Array<Array<Array<Array<Array<T>>>>>): T[];
//     // flatten<T>(x: Array<Array<Array<Array<T>>>>): T[];
//     // flatten<T>(x: Array<Array<Array<T>>>): T[];
//     // flatten<T>(x: Array<Array<T>>): T[];
//     // flatten<T>(x: Array<T>): T[];
...
//      */
//     forEachObjIndexed<T, Inp: Struct<T>>(fn: (val: T, key: string, obj?: Inp) => void, o: Inp): Inp;
//     forEachObjIndexed<T, Inp: Struct<T>>(fn: (val: T, key: string, obj?: Inp) => void): (o: Inp) => Inp;
//     // forEachObjIndexed<T, Inp: Struct<T>>: CurriedFunction2<(val: T, key: string, obj?: Inp) => void, Inp, Inp>;
// 
//     /**
//      * Creates a new object out of a list key-value pairs.
//      */
//     fromPairs<V>(pairs: List<[Prop, V]>): Obj<V>;
// 
//     /**
...
//      */
//     groupWith<T, R: List<T>>(fn: (x: T, y: T) => boolean, list: R): R[];
//     groupWith<T, R: List<T>>(fn: (x: T, y: T) => boolean): (list: R) => R[];
//     // groupWith<T, R: List<T>>: CurriedFunction2<(x: T, y: T) => boolean, R, R[]>;
// 
//     /**
...
//     has(s: Prop, ...rest: Array<void>): (obj: Struct<any>) => boolean;
//     // has: CurriedFunction2<Prop, Struct<any>, boolean>;
// 
//     // // bound generic, hopefully gives a hint as to what goes into obj
//     // has<T: Struct<any>>(s: Prop, obj: T): boolean;
//     // // has(s: Prop): <T: Struct<any>>(obj: T) => boolean; // mix
//     // // has<T: Struct<any>>: CurriedFunction2<Prop, T, boolean>;
// 
...
// 
//     // // bound generic, hopefully gives a hint as to what goes into obj
//     // hasIn<T: Struct<any>>(s: Prop, obj: T): boolean;
//     // // hasIn(s: Prop): <T: Struct<any>>(obj: T) => boolean; // mix
//     // // hasIn<T: Struct<any>>: CurriedFunction2<Prop, T, boolean>;
// 
//     // // free generic, helps make a few tests pass. TODO: kill this workaround?
...
//     // insertAll<T: List<any>>(index: number): CurriedFunction2<T, T, T>;
// 
...
//      */
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>(acc: V, xf: (list: List<T>) => U, list: List<T>): U;
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>(acc: V, xf: (list: List<T>) => U): (list: List<T>) => U;
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>(acc: V): CurriedFunction2<(list: List<T>) => U, List<T>, U>;
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>(acc: V): (xf: (list: List<T>) => U, list: List<T>) => U;
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>(acc: V): (xf: (list: List<T>) => U) => (list: List<T>) => U;
//     // into<T,U,V: CovariantOf<AccOpts<T,U>>>: CurriedFunction3<V, (list: List<T>) => U, List<T>, U>;
// 
//     // base
//     into<T, U, V: AccOpts<T, U>>(acc: V, xf: (list: List<T>) => U, list: List<T>): U;
//     into<T, U, V: AccOpts<T, U>>(acc: V, xf: (list: List<T>) => U):{
//         (list: List<T>): U;
//     };
//     into<T, U, V: AccOpts<T, U>>(acc: V):{
...
//      */
//     is<T>(ctor: Type<T>, val: any): boolean;
//     is<T>(ctor: Type<T>): (val: any) => boolean;
...
//     lens<V, U: Struct<any>>(getter: (s: U) => V, setter: (a: V, s: U) => U): ManualLens<V>;
//     lens<V, U: Struct<any>>(getter: (s: U) => V): (setter: (a: V, s: U) => U) => ManualLens<V>;
//     lens<V>(getter: (s: Struct<any>) => V): <U: Struct<any>>(setter: (a: V, s: U) => U) => ManualLens<V>;
...
//     // lens<V, U: Struct<any>>: CurriedFunction2<(s: U) => V, (a: V, s: U) => U, ManualLens<V>>;
// 
...
//      */
//     // lensIndex<T, K: $Keys<T>>(n: K): KeyLens<T, K>;
...
//      */
//     // lensProp<T, K: $Keys<T>>(n: K): KeyLens<T, K>;
...
//     map<T, U, M: Obj<T>>(fn: (value: T) => U, obj: M): Obj<U>;
//     map<T, U, M: Obj<T>>(fn: (value: T) => U, obj: M): Obj<U>;
//     // map<T, U>(fn: (value: T) => U): <M: Obj<T>>(obj: M) => {[K in keyof M]: U}; // mix
//     // map<T, U, M: Obj<T>>: CurriedFunction2<(value: T) => U, M, {[K in keyof M]: U}>;
// 
//     // object: Record version
//     map<T, U, K: string>(f: (x: T) => U, obj:Obj<T>): Obj<U>;
//     // map<T, U>(f: (x: T) => U): <K: string>(obj: {[key: K]: T}) => Record<K, U>; // mix
//     // map<T, U, K: string>: CurriedFunction2<(x: T) => U, {[key: K]: T}), Record<K, U>>;
// 
//     // functor
...
//     // map<F: Function, T1, T2>(fn: F, list: [T1, T2]): [F(T1), F(T1)];
//     // map<T, U, T1, T2>(fn: (x: T) => U, list: [T1, T2]): [typeof fn(T1), typeof fn(T1)];
//     // map<F: Function, T1, T2>(fn: F, list: [T1, T2]): [typeof F(T1), typeof F(T1)];
...
//      */
//     mapIndexed<T, U, V: List<T>>(fn: (val: T, key: number, list: V) => U, list: V): U[];
//     mapIndexed<T, U, V: List<T>>(fn: (val: T, key: number, list: V) => U): (list: V) => U[];
//     // mapIndexed<T, U, V: List<T>>: CurriedFunction2<(val: T, key: number, list: V) => U, V, U[]>;
// 
// 
//     /**
...
// 
//     // keyof
//     mapObjIndexed<T, V, M: Obj<T>>(fn: (value: T, key: string, obj?: M) => V, obj: M): Obj<V>;
//     mapObjIndexed<T, V, M: Obj<T>>(fn: (value: T, key: string, obj?: M) => V): (obj: M) => Obj<V>;
//     // mapObjIndexed<T, V, M: Obj<T>>: CurriedFunction2<(value: T, key: string, obj?: M) => V, M, {[K in keyof M]: V}>;
// 
//     // Record
//     mapObjIndexed<T, U, K: string>(f: (value: T, key: string, obj?: {[key: K]: T}) => U, obj: Obj<T>): Obj<U>;
//     mapObjIndexed<T, U, K: string>(f: (value: T, key: string, obj?: {[key: K]: T}) => U): <K: string>(obj: Obj<T>) => Obj<U>;  // potentially overwriting K but whatever
//     // mapObjIndexed<T, U, K: string>: CurriedFunction2<(value: T, key: string, obj?: {[key: K]: T}) => U, {[key: K]: T}), Record<K, U>>;
// 
//     /**
...
//     max<T: Ord>(a: T, b: T): T;
//     max<T: Ord>(a: T): (b: T) => T;
//     // max<T: Ord>: CurriedFunction2<T, T, T>;
// 
//     /**
...
//      */
//     merge<V1, V2, T1: Struct<V1>, T2: Struct<V2>>(a: T1, b: T2): T1 & T2;
//     merge<V1, T1: Struct<V1>>(a: T1): <V2, T2: Struct<V2>>(b: T2) => T1 & T2;
//     // merge<V1, V2, T1: Struct<V1>, T2: Struct<V2>>: CurriedFunction2<T1, T2, T1 & T2>;
// 
// 
//     /**
...
//     min<T: Ord>(a: T, b: T): T;
//     min<T: Ord>(a: T): (b: T) => T;
//     // min<T: Ord>: CurriedFunction2<T, T, T>;
// 
//     /**
//      * Takes a function and two values, and returns whichever value produces
...
//     objOf<K: string, V, T: Obj<V>>(key: K, value: V): T;
//     objOf<K: string>(key: K): <V, T: Obj<V>>(value: V) => T;
//     // objOf<K: string, V, T extends Record<K,V>>: CurriedFunction2<K, V, T>;
// 
//     // // Obj-based, loses key
...
//     or<U, T: {or?: (alt: U) => *|U;}>(fn1: T, val2: U): T|U;
//     or<U, T: {or?: (alt: U) => *|U;}>(fn1: T): (val2: U) => T|U;
//     // or<U, T: CovariantOf<{or?: (alt: U) => T|U;}>>: CurriedFunction2<T, U, T|U>;
// 
//     /**
...
// 
//     // key lens:
//     over<T, K: string>(lens: UnknownLens, fn: (v: any) => any, value: T): T;
//     over<T, K: string>(lens: UnknownLens, fn: (v: any) => any): (value: T) => T;
//     // over(lens: KeyLens<T,K>): <T, K: $Keys<T>>(fn: (v: T[K]) => T[K], value: T) => T;
//     over<T, K: string>(lens: UnknownLens): CurriedFunction2<(v: any) => any, T, T>;
//     // over<T, K: $Keys<T>>: CurriedFunction3<KeyLens<T,K>, (v: T[K]) => T[K], T, T>;
// 
//     // regular lenses:
// 
//     // // Functor version:
//     // over<V, T: Functor<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens, fn: (v: V) => V, value: T): T;
//     // over<V>(lens: ManualLens<V>|UnknownLens, fn: (v: V) => V): <T: Functor<V>>(value: T) => T;
//     // over<V, T: Functor<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens): CurriedFunction2<(v: V) => V, T, T>;
//     // // over<V, T: Functor<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens): (fn: (v: V) => V, value: T) => T;
//     // // over<V, T: Functor<V>>: CurriedFunction3<Lens<T,V>, (v: V) => V, T, T>;
// 
//     // // Functor version applied to array:
//     // over<V, T: List<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens, fn: (v: V) => V, value: T): V[];
//     // over<V, T: List<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens, fn: (v: V) => V): <T>(value: T) => V[];
//     // over<V, T: List<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens): CurriedFunction2<(v: V) => V, T, V[]>;
//     // // over<V, T: List<V>>(lens: Lens<T,V>|ManualLens<V>|UnknownLens): <V>(fn: (v: V) => V, value: T) => V[];
//     // // over<V, T: List<V>>: CurriedFunction3<Lens<T,V>|ManualLens<V>|UnknownLens, (v: V) => V, T, V[]>;
// 
//     // // unbound value:
...
//     // Functor version
//     over<V, T: Functor<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens, fn: (v: V) => V, value: T): T;
//     over<V, T: Functor<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens, fn: (v: V) => V):{
//         (value: T): T;
//     };
//     over<V, T: Functor<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens):{
//         (fn: (v: V) => V, value: T): T;
//         (fn: (v: V) => V):{
//             (value: T): T;
//         };
...
//     // Functor version applied to array
//     over<V, T: List<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens, fn: (v: V) => V, value: T): V[];
//     over<V, T: List<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens, fn: (v: V) => V):{
//         (value: T): V[];
//     };
//     over<V, T: List<V>>(lens: Lens<T, V>|ManualLens<V>|UnknownLens):{
//         (fn: (v: V) => V, value: T): V[];
//         (fn: (v: V) => V):{
//             (value: T): V[];
//         };
...
//     // objects
//     partition<V, T: Obj<V>,U: Obj<V>>(fn: (a: V) => boolean, obj: T & U) : [T,U];
//     // partition<T: Obj<V>,U: Obj<V>,V>: CurriedFunction2<(a: T) => boolean, obj: T & U, [T,U]>;
//     // objects, alternative notation
//     partition<T, U: Obj<T>>(fn: (a: T) => boolean, obj: U) : [Obj<T>, Obj<T>];
//     // partition<T, U: Obj<T>>: CurriedFunction2<(a: T) => boolean, U, [Partial<U>,Partial<U>]>;
// 
//     /**
...
//      * property is ignored.
//      */
//     pick<T, K: Prop>(names: List<K>, obj: T): T;
//     pick<T, K: Prop>(names: List<K>): (obj: T) => T;
//     // pick<T, K: $Keys<T>>: CurriedFunction2<List<K>, T, Pick<T, K>>;
// 
...
// 
//     // infer
//     pluck<U, T: Struct<U>, K: $Keys<T>>(p: K, list: List<T>): U[]; // fails on number keys
//     pluck<U, T: Struct<U>, K: $Keys<T>>(p: K): (list: List<T>) => U[]; // doesn't work, T info late
//     // pluck<T: Struct<any>, K: $Keys<T>>: CurriedFunction2<K, List<T>, T[K][]>;
// 
...
// 
//     // infer
//     project<T, K: Prop>(props: List<K>, objs: List<T>): T[];
//     project<T, K: Prop>(props: List<K>): (objs: List<T>) => T[]; // T info probably too late
//     // project<T, K: $Keys<T>>: CurriedFunction2<List<K>, List<T>, Pick<T, K>[]>;
// 
//     // supply return object type manually when unable to infer it...
...
//     // prop<T, K: $Keys<T>>(p: K): (obj: T) => T[K]; // T info late
//     // prop<T, K: $Keys<T>>: CurriedFunction2<K, T, T[K]>;
//     // prop<K: Prop>(p: K): <T, K: $Keys<T>>(obj: T) => T[K]; // K redefined, fails
//     // prop<T, K: Prop>: CurriedFunction2<K, T, T[K]>;
// 
//     // Record version, more curry-friendly
//     prop<K: string, V, T: Obj<V>>(p: K, obj: T): V; // uncurried adds value only for {} from e.g. degeneration
//     prop<K: string>(p: K): <V, T: Obj<V>>(obj: T) => V;
//     // prop<K: string, V, T extends Record<K,V>>: CurriedFunction2<K, T, V>;
// 
//     /**
...
//      * filter a list.
//      */
//     // propEq<T: Struct<any>>(name: Prop, val: any, obj: T): boolean;
//     // propEq<T: Struct<any>>(name: Prop, val: any): (obj: T) => boolean;
//     // propEq<T: Struct<any>>(name: Prop): CurriedFunction2<any, T, boolean>;
//     // // propEq<T: Struct<any>>(name: Prop): (val: any, obj: T) => boolean;
//     // // propEq<T: Struct<any>>(name: Prop): (val: any) => (obj: T) => boolean;
//     // // propEq<T: Struct<any>>: CurriedFunction3<Prop, any, T, boolean>;
// 
//     // base
//     propEq<T: Struct<any>>(name: Prop, val: any, obj: T): boolean;
...
//     };
//     propEq(name: Prop):{
//         <T: Struct<any>>(val: any, obj: T): boolean;
//         (val: any):{
//             <T: Struct<any>>(obj: T): boolean;
//         };
//     };
...
// 
//     // Record
//     propIs<T: Function, K: string, V, U: Obj<V>>(type: T, name: K, obj: U): boolean;
//     propIs<T: Function, K: string>(type: T, name: K): <V, U: Obj<V>>(obj: U) => boolean;
//     // propIs<T: Function>(type: T): {
//     //     <K: string, V, U extends Record<K,V>>(name: K, obj: U): obj is (U & {[key: K]: T});
//     //     <K: string>(name: K): <V, U extends Record<K,V>>(obj: U) => obj is (U & {[key: K]: T});
//     // }
//     // propIs<T: Function, K: string, V, U extends Record<K,V>>: CurriedFunction3<T, K, U, V is (V & {[key: K]: T})>; // obj is? name unavailable...
// 
//     // inference, fails if name and object are supplied separately
//     propIs<T: Function, V>(type: T, name: Prop, obj: V): boolean;
//     // propIs<T: Function, V, K extends keyof V>(type: T, name: K): (obj: V) => obj is (V & {[key: K]: T});  // object info not available in time :(
//     // propIs<T: Function>(type: T): {
//     //     <V, K extends keyof V>(name: K, obj: V): obj is (V & {[key: K]: T});
//     //     <V, K extends keyof V>(name: K): (obj: V) => obj is (V & {[key: K]: T});  // object info not available in time :(
//     // }
//     // propIs<T: Function, V, K extends keyof V>: CurriedFunction3<T, K, V, V is (V & {[key: K]: T})>; // obj is? name unavailable...
// 
...
//     propIs<T: Function>(type: T): {
//         // record
//         <K: string, V, U: Obj<V>>(name: K, obj: U): boolean;
//         <K: string>(name: K): <V, U: Obj<V>>(obj: U) => boolean;
//         // keyof
//         <V>(name: Prop, obj: V): boolean;
//         // <V, K extends keyof V>(name: K): (obj: V) => obj is (V & {[key: K]: T});  // object info not available in time :(
//     };
// 
//     /**
...
//     // propOr<T, K: string, V, U extends Record<K,V>>(val: T, p: K, obj: U): V|T;
//     // propOr<T, K: string>(val: T, p: K): <V, U extends Record<K,V>>(obj: U) => V|T;
//     // propOr<T, K: string, V, U extends Record<K,V>>(val: T): CurriedFunction2<K, U, V|T>;
//     // // propOr<T, K: string, V, U extends Record<K,V>>: CurriedFunction3<T, K, U, V|T>;
// 
//     // infer with keyof (not curry-friendly), allowing a default value with a type different from the actual one
//     propOr<T,U,K: $Keys<U>>(val: T, p: K, obj: Obj<K>): K|T; // obj[K]?
//     propOr<T,U,K: $Keys<U>>(val: T, p: K): (obj: Obj<K>) => K|T;  // generics too early?
//     propOr<T,U,K: $Keys<U>>(val: T): CurriedFunction2<K, Obj<K>, K|T>;  // generics too early?
//     // propOr<T>(val: T): <U,K: $Keys<U>>(p: K, obj: U) => U[K]|T;
//     // propOr<T>(val: T): <U,K: $Keys<U>>(p: K) => (obj: U) => U[K]|T;  // U too early?
//     // propOr<T,U,K: $Keys<U>>: CurriedFunction3<T, K, U, U[K]|T>;
// 
...
//     // Record-based?
//     // props<K extends keyof T, T: Struct<any>>(ps: List<K>, obj: Struct<T>): ???;
// 
//     /**
...
//     // propSatisfies<V, K: string, U extends Record<K,V>>(pred: Pred<V>, name: K, obj: U): boolean;
//     // propSatisfies<V, K: string>(pred: Pred<V>, name: K): <U extends Record<K,V>>(obj: U) => boolean;
//     // propSatisfies<V, K: string, U extends Record<K,V>>(pred: Pred<V>): CurriedFunction2<K, U, boolean>;
//     // // propSatisfies<V, K: string, U extends Record<K,V>>: CurriedFunction3<Pred<V>, K, U, boolean>;
// 
//     // // keyof, info too late on currying
//     // propSatisfies<U: Struct<any>, K: $Keys<U>>(pred: Pred<U[K]>, name: Prop, obj: U): boolean;
...
// 
//     // Record (curry-friendly)
//     propSatisfies<V, K: string, U: Obj<V>>(pred: Pred<V>, name: K, obj: U): boolean;
//     propSatisfies<V, K: string>(pred: Pred<V>, name: K):{
//         <U: Obj<V>>(obj: U): boolean;
//     };
//     propSatisfies<V>(pred: Pred<V>):{
//         <K: string, U: {[key: K]: V}>(name: K, obj: U): boolean;
//         <K: string>(name: K):{
//             <U: Obj<V>>(obj: U): boolean;
//         };
//     };
...
//      */
//     // reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: Number, list: R) => TResult|Reduced, acc: TResult, list: R): TResult;
//     // reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: Number, list: R) => TResult|Reduced, acc: TResult): (list: R) => TResult;
//     // reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: Number, list: R) => TResult|Reduced): CurriedFunction2<TResult, R, TResult>;
//     // // reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: Number, list: R) => TResult|Reduced): (acc: TResult, list: R) => TResult;
//     // // reduce<T, TResult, R: List<T>>: CurriedFunction3<(acc: TResult, elem: T, idx: Number, list: R) => TResult|Reduced, TResult, R, TResult>;
//     // base
//     reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult|Reduced, acc: TResult, list: R): TResult;
//     reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult|Reduced, acc: TResult):{
//         (list: R): TResult;
//     };
//     reduce<T, TResult, R: List<T>>(fn: (acc: TResult, elem: T, idx: number, list: R) => TResult|Reduced):{
...
//     // reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any, keyFn: (elem: T) => string, list: R): TResult;
//     // reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any, keyFn: (elem: T) => string): (list: R) => TResult;
//     // reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any): CurriedFunction2<(elem: T) => string, R, TResult>;
//     // reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult): CurriedFunction3<TResult|any, (elem: T) => string, R, TResult>;
//     // // reduceBy<T, TResult, R: List<T>>: CurriedFunction4<(acc: TResult, elem: T, idx: number, list: R) => TResult, TResult|any, (elem: T) => string, R, TResult>;
//     // base
//     reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any, keyFn: (elem: T) => string, list: R): TResult;
//     reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any, keyFn: (elem: T) => string):{
//         (list: R): TResult;
//     };
//     reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult, acc: TResult|any):{
//         (keyFn: (elem: T) => string, list: R): TResult;
//         (keyFn: (elem: T) => string):{
//             (list: R): TResult;
//         };
//     };
//     reduceBy<T, TResult, R: List<T>>(valueFn: (acc: TResult, elem: T, idx: number, list: R) => TResult):{
...
// 
//     // object
//     reject<T,U: Obj<T>>(pred: Pred<T>, obj: U) : U;
//     // reject<T>(pred: Pred<T>): <U: Obj<T>>(obj: U) => Partial<U>; // mix
//     // reject<T,U: Obj<T>>: CurriedFunction2<Pred<T>, U, Partial<U>>;
// 
//     // mixed
...
// 
//     // // key lens:
//     // set<T, K: $Keys<T>>(lens: KeyLens<T,K>, a: T[K], obj: T): T;
//     // set<T, K: $Keys<T>>(lens: KeyLens<T,K>, a: T[K]): (obj: T) => T;
//     // set<T, K: $Keys<T>>(lens: KeyLens<T,K>): CurriedFunction2<T[K], T, T>;
//     // // set<T, K: $Keys<T>>: CurriedFunction3<KeyLens<T,K>, T[K], T, T>;
// 
//     // regular lenses:
// 
...
//      */
//     // slice<T: List<any>>(a: number, b: number, list: T): T;
//     // slice(a: number, b: number): <T: List<any>>(list: T) => T;
//     // slice<T: List<any>>(a: number): CurriedFunction2<number, T, T>;
//     // // slice(a: number): <T: List<any>>(b: number, list: T) => T;
//     // // slice(a: number): <T: List<any>>(b: number) => (list: T) => T;
//     // // slice<T: List<any>>: CurriedFunction3<number, number, T, T>;
// 
//     // base
//     slice<T: List<any>>(a: number, b: number, list: T): T;
...
//      */
//     sortBy<T, K: Ord>(fn: (a: T) => K, list: List<T>): T[];
//     sortBy<T, K: Ord>(fn: (a: T) => K): (list: List<T>) => T[];
//     // sortBy<T, K: Ord>: CurriedFunction2<(a: T) => K, List<T>, T[]>;
// 
//     /**
...
//      */
//     splitEvery<T, R: List<T>>(a: number, list: R): R[];
//     splitEvery(a: number): <T, R: List<T>>(list: R) => R[];
//     // splitEvery<T, R: List<T>>: CurriedFunction2<number, R, R[]>;
// 
//     /**
...
//      */
//     splitWhen<T, R: List<T>>(pred: Pred<T>, list: R): R[];
//     splitWhen<T>(pred: Pred<T>): <R: List<T>>(list: R) => R[];
//     // splitWhen<T, R: List<T>>: CurriedFunction2<Pred<T>, R, R[]>;
// 
//     /**
...
//      */
//     tail<T: List<any>>(list: T): T;
// 
//     /**
//      * Returns a new list containing the first `n` elements of the given list.  If
//      * `n > * list.length`, returns a list of `list.length` elements.
//      */
//     take<T: List<any>>(n: number, xs: T): T;
//     take(n: number): <T: List<any>>(xs: T) => T;
//     // take<T: List<any>>: CurriedFunction2<number, T, T>;
// 
// 
//     /**
...
//      */
//     // = take
//     takeLast<T: List<any>>(n: number, xs: T): T;
//     takeLast(n: number): <T: List<any>>(xs: T) => T;
//     // takeLast<T: List<any>>: CurriedFunction2<number, T, T>;
// 
//     /**
...
//      */
//     // = takeWhile
//     takeLastWhile<T, R: List<T>>(pred: Pred<T>, list: R): R;
//     takeLastWhile<T>(pred: Pred<T>): <R: List<T>>(list: R) => R;
//     // takeLastWhile<T, R: List<T>>: CurriedFunction2<Pred<T>, R, R>;
// 
//     /**
...
//      * `false`.
//      */
//     takeWhile<T, R: List<T>>(pred: Pred<T>, list: R): R;
//     takeWhile<T>(pred: Pred<T>): <R: List<T>>(list: R) => R;
//     // takeWhile<T, R: List<T>>: CurriedFunction2<Pred<T>, R, R>;
// 
//     /**
...
// 
//     // // key lens:
//     // view<T, K: $Keys<T>>(lens: KeyLens<T,K>, obj: T): T[K];
//     // view<T, K: $Keys<T>>(lens: KeyLens<T,K>): (obj: T) => T[K];
//     // // view<T, K: $Keys<T>>: CurriedFunction2<KeyLens<T,K>, T, T[K]>;
// 
//     // regular lenses:
// 
//     // smart approach, unreliable:
...
//      */
//     xprod<K,V>(as: List<K>, bs: List<V>): Array<[K, V]>;
//     xprod<K>(as: List<K>): <V>(bs: List<V>) => Array<[K, V]>;
//     // xprod<K,V>: CurriedFunction2<List<K>, List<V>, Array<[K, V]>>;
// 
//     /**
//      * Creates a new list out of the two supplied by pairing up equally-positioned items from
//      * both lists. Note: `zip` is equivalent to `zipWith(function(a, b) { return [a, b] })`.
//      */
//     zip<K,V>(list1: List<K>, list2: List<V>): Array<[K, V]>;
//     zip<K>(list1: List<K>): <V>(list2: List<V>) => Array<[K, V]>;
//     // zip<K,V>: CurriedFunction2<List<K>, List<V>, Array<[K, V]>>;
// 
//     /**
