...
module.exports = function (expressApp: express$Application, app: Application) {
  ...
  function defineRoutes(router) {
    ...
    router.get('/who-am-i', (req: express$Request, res, next) => {
      if (!ssoIsWhoamiActivated) {
        return next(errors.unknownResource());
      }

      const ssoCookie = req.signedCookies.sso;
    ...
    router.post('/login', (req: RequestWithContext, res, next) => {
      ...
      api.call('auth.login', req.context, params, (err, result) => {
    ...
    router.post('/logout',
      ...
      (req: RequestWithContext, res, next) => {
        clearSSOCookie(res);
