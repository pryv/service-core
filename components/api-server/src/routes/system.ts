...
module.exports = function system(
  ...
  expressApp.get(
    Paths.System + '/user-info/:username',
  ...
  expressApp.delete(
    Paths.System + '/users/:username/mfa',
    setMethodId('system.deactivateMfa'),
    function (req: express$Request, res, next) {
      systemAPI.call(
        req.context,
        { username: req.params.username },
        methodCallback(res, next, 204)
      );
    }
  );
  ...
  // --------------------- health checks ----------------- //
  expressApp.get(
    Paths.System + '/check-platform-integrity',
