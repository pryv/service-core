...
class Application {
  ...
  loadCustomExtension(): Extension | undefined | null {
    ...
    if (customAuthStepFnPath) {
      ...
      // default location:
      logger.debug(
        'Trying to load CustomAuthStepFn from ' +
          defaultFolder +
          '/' +
          name +
          '.js'
