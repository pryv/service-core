...
describe('accesses (personal)', function () {
  ...
  describe('PUT /<token>', function () {
    ...
    it('[66GW] must modify the shared access with the sent data', function (done) {
    ...
    it('[F67O] must modify the personal access with the specified data', function (done) {
    ...
    it('[U04A] must return an error if the access does not exist', function (done) {
    ...
    it('[P2UC] must return an error if the sent data is badly formatted', function (done) {
      var data = {
        permissions: [
          {
            streamId: testData.streams[0].id,
    ...
    it('[KK1F] must return an error if an access with the same name and type already exists', (done) => {
      req()
    ...
    describe('forbidden updates of protected fields', function () {
      ...
      it('[4Y59] must prevent update of protected fields and throw a forbidden error in strict mode', function (done) {
      ...
      it('[6KC8] must prevent update of protected fields and log a warning in non-strict mode', function (done) {
        const forbiddenUpdate = {
          id: 'forbidden',
          token: 'forbidden',
          type: 'personal',
      ...
      it('[B8MA] must forbid to elevate a read level into a manage level using a contribute access ', function (done) {
      ...
      it('[AMEV] must forbid to extend the permission streamIds beyond the authorized context ', function (done) {
        // In this test we reproduce a situation in which an attacker who
        // was granted a contribute app access can elevate the privileges
