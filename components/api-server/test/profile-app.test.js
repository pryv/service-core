...
describe('profile (app)', function () {
  ...
  describe('GET /public', function () {
    ...
    it('PYC1-must return publicly shared key-value profile info', function (done) {
  ...
  describe('GET /app', function () {
    ...
    it('R2CV-must return key-value settings for the current app', function (done) {
      request.get(path, appAccess.token).end(function (res) {
        validation.check(res, {
          status: 200,
          schema: methodsSchema.get.result,
    ...
    it('4UG3-must refuse requests with a shared access token', function (done) {
    ...
    it('STTI-must refuse requests with a personal access token', function (done) {
  ...
  describe('PUT /app', function () {
    ...
    it('V8OQ-must add/update/remove the specified keys without touching the others', function (done) {
      var data = {
    ...
    it('T79T-must refuse requests with a shared access token', function (done) {
    ...
    it('FY8T-must refuse requests with a personal access token', function (done) {
      var personalRequest = helpers.request(server.url);
      async.series([
        personalRequest.login.bind(personalRequest, user),
        function (stepDone) {
