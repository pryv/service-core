...
describe('root', function() {
  ...
  describe('GET /', function() {
    it('TTCA-should return basic server meta information as JSON when requested', function(done) {
      superagent
        .get(path())
    ...
    it('I30T-should return basic server meta information as text otherwise', function(done) {
      superagent
        .get(path())
    ...
    it('MGFL-should return an error if trying to access an unknown user account', function(done) {
  ...
  describe('All requests:', function() {
    it('B9ZT-should return correct common HTTP headers + meta data in response body', function(done) {
      var origin = 'https://test.pryv.io',
          allowMethod = 'GET',
          allowHeaders = 'Content-Type';
      request
        .get(path() + user.username + '/events')
        .set('Origin', origin)
    ...
    it('6FC1-should return meta data in response body for errors as well', function(done) {
    ...
    it('OYOI-should translate the username in subdomain also when it only contains numbers', function(done) {
    ...
    it('DNME-should support POSTing "urlencoded" content with _json and _auth fields', function() {
      return request
    ...
    it('ZSK7-should support POSTing "urlencoded" content with _json, _method (PUT) and _auth fields', function(done) {
      request
    ...
    it('Q7N8-should support POSTing "urlencoded" content with _json, _method (DELETE) and _auth fields', function(done) {
      request
        .post(path() + user.username + '/streams/' + testData.streams[3].id)
        .type('form')
        .unset('authorization')
    ...
    it('WSL5-should properly handle JSON errors when POSTing "urlencoded" content with _json field', function(done) {
      request
        .post(path() + user.username + '/streams')
        .type('form')
        .unset('authorization')
    ...
    it('QRVJ-should update the access\'s "last used" time and *internal* request counters', function(done) {
      var expectedTime,
      ...
      async.series(
        [
          ...
          function checkExposedAccess(stepDone) {
            request
              .get(path() + user.username + '/accesses')
              .end(function(res) {
  ...
  describe('OPTIONS /', function() {
    it('S2W6-should return OK', function(done) {
  ...
  describe('GET /access-info', function() {
    ...
    it('3NPZ-must return current access information', function(done) {
      request
  ...
  describe('POST / (i.e. batch call)', function() {
    ...
    it('ZYZ2-must execute the given method calls and return the results', function(done) {
      var calls = [
        {
    ...
    it('V5AS-must return an error if the sent data is badly formatted', function(done) {
      var calls = [
        {
          method: 'events.create',
