...
describe('Configuration', () => {
  describe('.load(basePath)', () => {
    describe('when started in fixture 1', () => {
      it('44SA-finds all configuration files', async () => {
  ...
  describe('with fileLocations1 fixture config', () => {
    ...
    it('A3SD-has the right register url and key', async () => {  
    ...
    it('GT4J-has mongodb configured correctly (including defaults)', () => {
