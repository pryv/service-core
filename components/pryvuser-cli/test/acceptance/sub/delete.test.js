...
describe('OpDeleteUser', () => {
  ...
  it('R5C2-executes preflight and then deletes the user', async () => {
    // FLOW Forbidden assignment - used for mocking.
  ...
  it('ATLU-stops after preflight if preflight fails', async () => {
    // FLOW Forbidden assignment - used for mocking.
  ...
  it('GTI4-stops if user doesnt confirm', async () => {
    // FLOW Forbidden assignment - used for mocking.
    op.preflightChecks = sinon.fake.resolves();
    // FLOW Forbidden assignment - used for mocking.
  ...
  describe('when stubbing connections to all subsystems', () => {
    ...
    it('Q8R8-completes preflight successfully', async () => {
    ...
    it('YVPG-deletes the user', async () => {
      for (const conn of connections) {
