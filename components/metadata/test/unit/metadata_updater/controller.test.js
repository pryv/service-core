...
describe('Metadata Updater/Controller', () => {
  ...
  describe('#runEach(ms)', () => {
    it('I644-starts a timer and runs #act every n ms', (done) => {
  ...
  describe('#flushOp(update)', () => {
    ...
    it('JYOF-constructs an Flush operation for the update and returns it', () => {
  ...
  describe('#act', () => {
    ...
    it('412W-pulls elapsed updates and flushes them to MongoDB', async () => {
      const flushOps = [];
