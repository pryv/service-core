...
class SystemStreamsSerializer {
  ...
  // static
  static allAsTree: Array<SystemStream> | undefined | null;
  static allMap: Map<string, boolean> | undefined | null;
  static allStreamIds: Array<string> | undefined | null;

  static readable: Array<Stream> | undefined | null;

  static readableAccountMap: Map<string, SystemStream> | undefined | null;
  static readableAccountMapForTests:
    | Map<string, SystemStream>
    | undefined
    | null;
  static readableAccountStreamIds: Array<string> | undefined | null;

  static editableAccountMap: Map<string, SystemStream> | undefined | null;
  static editableAccountStreamIds: Array<string> | undefined | null;

  static accountMap: Map<string, Array<string>> | undefined | null;
  static accountMapWithOptions: Array<string> | undefined | null;
  static accountLeavesMap: Map<string, SystemStream> | undefined | null;
  static accountStreamIds: Array<string> | undefined | null;

  static indexedAccountStreamsIdsWithoutPrefix:
    | Array<string>
    | undefined
    | null;
  static uniqueAccountStreamsIdsWithoutPrefix: Array<string> | undefined | null;

  static accountStreamsIdsForbiddenForReading: Array<string> | undefined | null;
  ...
  static accountChildren: Array<SystemStream> | undefined | null;

  // Maps used for quick translation from without prefix to with
  static streamIdWithPrefixToWithout: Map<string, string> | undefined | null;
  ...
  static options: Map<string, string> | undefined | null;
  ...
  static getAllRootStreamIdsThatRequireReadRightsForEventsGet(): Array<string> {
    ...
    for (const rootStream of SystemStreamsSerializer.getAll()) {
      if (
        rootStream.id.indexOf(PRYV_PREFIX) === 0 &&
        rootStream.id !== ':_system:helpers'
      )
        SystemStreamsSerializer.allRootStreamIdsThatRequireReadRightsForEventsGet.push(
          rootStream.id
        );
    }
  ...
  static getAccountChildren(): Array<SystemStream> {
    if (SystemStreamsSerializer.accountChildren != null)
      return SystemStreamsSerializer.accountChildren;
    SystemStreamsSerializer.accountChildren = treeUtils.findById(
      this.allAsTree,
      PRYV_PREFIX + 'account'
    ).children;
    return SystemStreamsSerializer.accountChildren;
  ...
  static getReadableAccountMap(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.readableAccountMap != null)
  ...
  static getReadableAccountStreamIds(): Array<string> {
    if (SystemStreamsSerializer.readableAccountStreamIds != null)
      return SystemStreamsSerializer.readableAccountStreamIds;
    SystemStreamsSerializer.readableAccountStreamIds = Object.keys(
      SystemStreamsSerializer.getReadableAccountMap()
    );
    return SystemStreamsSerializer.readableAccountStreamIds;
  }
  ...
  static getReadableAccountMapForTests(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.readableAccountMapForTests != null)
      return SystemStreamsSerializer.readableAccountMapForTests;

    const streams = filterMapStreams(
      SystemStreamsSerializer.getAccountChildren(),
      IS_SHOWN
    );
    delete streams[
      SystemStreamsSerializer.addPrivatePrefixToStreamId('storageUsed')
    ];
  ...
  static getEditableAccountMap(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.editableAccountMap != null)
      return SystemStreamsSerializer.editableAccountMap;

    SystemStreamsSerializer.editableAccountMap = filterMapStreams(
      SystemStreamsSerializer.getAccountChildren(),
      IS_EDITABLE
    );
  ...
  static getEditableAccountStreamIds(): Array<string> {
    if (SystemStreamsSerializer.editableAccountStreamIds != null)
      return SystemStreamsSerializer.editableAccountStreamIds;

    SystemStreamsSerializer.editableAccountStreamIds = Object.keys(
  ...
  static getAccountMap(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.accountMap != null)
      return SystemStreamsSerializer.accountMap;

    SystemStreamsSerializer.accountMap = filterMapStreams(
      SystemStreamsSerializer.getAccountChildren(),
      ALL
    );
    return SystemStreamsSerializer.accountMap;
  ...
  static getAccountStreamIds(): Array<string> {
    if (SystemStreamsSerializer.accountStreamIds != null)
      return SystemStreamsSerializer.accountStreamIds;

    SystemStreamsSerializer.accountStreamIds = Object.keys(
  ...
  static getAccountStreamIdsForUser(): Map<string, Array<string>> {
    if (SystemStreamsSerializer.allAccountStreamIdsForUser != null)
  ...
  static getAccountMapWithOptions(): Map<string, boolean> {
    if (SystemStreamsSerializer.accountMapWithOptions != null)
      return SystemStreamsSerializer.accountMapWithOptions;
    const accountMapWithOptions = _.cloneDeep(
      SystemStreamsSerializer.getAccountMap()
    );
    accountMapWithOptions[
      SystemStreamsSerializer.options.STREAM_ID_ACCOUNT
    ] = true;
    accountMapWithOptions[
    ...
    accountMapWithOptions[
      SystemStreamsSerializer.options.STREAM_ID_HELPERS
    ] = true;
  ...
  static getAccountLeavesMap(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.accountLeavesMap != null)
      return SystemStreamsSerializer.accountLeavesMap;

    const flatStreamsList = treeUtils.flattenTreeWithoutParents(
      SystemStreamsSerializer.getAccountChildren()
    );
    let streamsMap = {};
  ...
  static getIndexedAccountStreamsIdsWithoutPrefix(): Array<string> {
    if (SystemStreamsSerializer.indexedAccountStreamsIdsWithoutPrefix != null)
      return SystemStreamsSerializer.indexedAccountStreamsIdsWithoutPrefix;
    let indexedStreamIds = Object.keys(
      filterMapStreams(SystemStreamsSerializer.getAccountChildren(), IS_INDEXED)
    );
  ...
  static isUniqueAccountField(field: string): Array<string> {
    ...
    return SystemStreamsSerializer.getUniqueAccountStreamsIdsWithoutPrefix().includes(
      field
    );
  }
  ...
  static getUniqueAccountStreamsIdsWithoutPrefix(): Array<string> {
    if (SystemStreamsSerializer.uniqueAccountStreamsIdsWithoutPrefix != null)
      return SystemStreamsSerializer.uniqueAccountStreamsIdsWithoutPrefix;
    const uniqueStreamIds = Object.keys(
      filterMapStreams(SystemStreamsSerializer.getAccountChildren(), IS_UNIQUE)
    );
  ...
  static getAccountStreamsIdsForbiddenForReading(): Array<string> {
    if (SystemStreamsSerializer.accountStreamsIdsForbiddenForReading != null)
  ...
  static hasSystemStreamPrefix(streamIdWithPrefix: string): boolean {
    return (
      streamIdWithPrefix.startsWith(PRYV_PREFIX) ||
  ...
  static addPrivatePrefixToStreamId(streamId: string): string {
    const streamIdWithPrefix =
      SystemStreamsSerializer.privateStreamIdWithoutPrefixToWith[streamId];
    if (streamIdWithPrefix == null)
      throw new Error(
        'trying to call addCustomerPrefixToStreamId() with non-private streamId: ' +
          streamId
      );
  ...
  static addCustomerPrefixToStreamId(streamId: string): string {
    const streamIdWithPrefix =
      SystemStreamsSerializer.customerStreamIdWithoutPrefixToWith[streamId];
    if (streamIdWithPrefix == null)
      throw new Error(
        'trying to call addCustomerPrefixToStreamId() with non-customer streamId: ' +
          streamId
      );
    return streamIdWithPrefix;
  }
  ...
  static addCorrectPrefixToAccountStreamId(streamId: string): string {
    const streamIdWithPrefix: string =
      SystemStreamsSerializer.accountStreamIdWithoutPrefixToWith[streamId];
    if (streamIdWithPrefix == null)
      throw new Error(
        'trying to call addCorrectPrefixToAccountStreamId() with non-account streamId: ' +
          streamId
      );
    return streamIdWithPrefix;
  }
  ...
  static getAll(): Array<SystemStream> {
    if (SystemStreamsSerializer.allAsTree != null)
  ...
  static getAllMap(): Map<string, SystemStream> {
    if (SystemStreamsSerializer.allMap != null)
  ...
  static getReadable(): Array<Stream> {
    if (SystemStreamsSerializer.readable)
      return SystemStreamsSerializer.readable;
    SystemStreamsSerializer.readable = treeUtils.filterTree(
      this.allAsTree,
      false,
      (s) => s[IS_SHOWN]
    );
    SystemStreamsSerializer.readable = treeUtils.cloneAndApply(
      this.readable,
      (s) => _.pick(s, StreamProperties)
    );
    return SystemStreamsSerializer.readable;
  }
}
 ...
 */
function filterMapStreams(
  streams: Array<SystemStream>,
  filter: string = IS_SHOWN
): Map<string, SystemStream> {
...
function initializeSerializer(serializer) {
  ...
  const allAsArray: Array<SystemStream> = treeUtils.flattenTree(
    SystemStreamsSerializer.allAsTree
  );
  ...
  function initializeTranslationMaps(streamIdsWithPrefix: Array<string>) {
    ...
    streamIdsWithPrefix.forEach((streamIdWithPrefix) => {
      const streamIdWithoutPrefix =
        _removePrefixFromStreamId(streamIdWithPrefix);
      SystemStreamsSerializer.streamIdWithPrefixToWithout[streamIdWithPrefix] =
    ...
    function isAccount(streamIdWithPrefix: string): boolean {
      return (
        SystemStreamsSerializer.getAccountMap()[streamIdWithPrefix] != null
      );
    }
  }
}
...
function _removePrefixFromStreamId(streamId: string): string {
  if (streamId.startsWith(PRYV_PREFIX))
    return streamId.substr(PRYV_PREFIX.length);
  if (streamId.startsWith(CUSTOMER_PREFIX))
    return streamId.substr(CUSTOMER_PREFIX.length);
  throw new Error(
    'serializer initialization: removePrefixFromStreamId(streamId) should be called with a prefixed streamId'
  );
}
