...
class Client {
  ...
  onCall(
    ...
    channel
      ...
      .send(methodName, 'arg1', requestData, (...args) =>
        this.onResponse(responseType, cb, ...args)
      );
  }
...
type ForwarderCallback = (err: Error | undefined | null, res: any) => unknown;
