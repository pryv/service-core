...
function loadCustomAuthStepFn(customExtensions): Extension | undefined | null {
...
async function start() {
  ...
  const customAuthStepExt = loadCustomAuthStepFn(
  ...
  await require('./routes/event-previews')(
    expressApp,
...
type ExtendedAttributesServer = Server & {
  key?: string;
  url?: string;
};
