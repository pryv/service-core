...
describe('Querying data from a HF series', function() {
  ...
  it('17BO-should refuse a query for an unknown user', function () {
  ...
  it('458Y-should refuse a query missing the authorization token', function () {
    return server.request()
  ...
  it('E989-should refuse a query containing an unauthorized token', function () {
    return server.request()
      .get(`/${userId}/events/${eventId}/series`)
  ...
  it('QPL0-should return an unknown resource error when querying data ' +
  ...
  it('NMOJ-should refuse a query containing parameters with the wrong format', function () {
    return server.request()
      .get(`/${userId}/events/${eventId}/series`)
      .set('authorization', accessToken)
      .query({
  ...
  it('4F5H-should refuse a query when toTime is before fromTime', function () {
    return server.request()
      .get(`/${userId}/events/${eventId}/series`)
      .set('authorization', accessToken)
      .query({
